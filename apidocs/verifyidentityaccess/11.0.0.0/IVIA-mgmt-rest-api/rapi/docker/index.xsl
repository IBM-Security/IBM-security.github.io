...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  <xsl:template match="index">
    ...
    <head>
      ...
      <title>Verify Identity Access Rest API</title>
    </head>

    <body>
      <div class="heading">
        <h1>Verify Identity Access REST API</h1>
      </div>
      <table role="presentation">
        ...
        <tr>
          <td width="100%" colspan="2">
            <input type="text" id="rapi_filter" placeholder="title or URI" style="width:100%" 
              onkeydown="if (event.keyCode == 13) rapi_filter()"></input>
          </td>
        </tr>
        <tr>
          <td width="50%">
            <button id="filter_apply" type="submit" onclick="rapi_filter()" style="width:100%;">Apply Filter</button>
          </td>
          <td width="50%">
